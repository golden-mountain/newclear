  ...
  render() {
    ...
    return (
      <aside className="offsidebar hide">
        ...
        <Tabs id={ this.state.key }activeKey={ this.state.key } onSelect={ this.handleSelect.bind(this) } justified>
          <Tab eventKey={ 1 } title={ tabIconA }>
            ...
            <div className="p">
              ...
              <div className="table-grid mb">
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-a.css">
                ...
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-b.css">
                ...
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-c.css">
                      <input type="radio" name="setting-theme" />
                      <span className="icon-check"></span>
                      <span className="split">
                ...
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-d.css">
                      <input type="radio" name="setting-theme" />
                      <span className="icon-check"></span>
                      <span className="split">
              ...
              <div className="table-grid mb">
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-e.css">
                      <input type="radio" name="setting-theme" />
                      <span className="icon-check"></span>
                      <span className="split">
                ...
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-f.css">
                      <input type="radio" name="setting-theme" />
                      <span className="icon-check"></span>
                      <span className="split">
                ...
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-g.css">
                      <input type="radio" name="setting-theme" />
                      <span className="icon-check"></span>
                      <span className="split">
                ...
                <div className="col mb">
                  <div className="setting-color">
                    <label data-load-css="theme-h.css">
                      <input type="radio" name="setting-theme" />
                      <span className="icon-check"></span>
                      <span className="split">
