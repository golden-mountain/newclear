...
class FormStand extends React.Component {
          ...
          <form method="get" action="/" className="form-horizontal">
            <fieldset>
              ...
              <div className="form-group">
                ...
                <Col sm={ 10 }>
                  <Input type="text" className="form-control form-control-rounded" />
                </Col>
              </div>
            </fieldset>
            <fieldset>
            ...
            {/* <fieldset className="last-child">
              <div className="form-group">
                ...
                <Col sm={ 10 }>
                  <Input type="select" name="account" className="form-control m-b">
