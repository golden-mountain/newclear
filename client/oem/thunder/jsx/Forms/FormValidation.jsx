                            ...
                            <div className="panel panel-default">
                                ...
                                <div className="panel-body">
                                    <div className="form-group">
                                        ...
                                        <Input type="text" name="email" required="required" className="form-control" />
                                    </div>
                                    <div className="form-group">
                                        <label className="control-label">Password *</label>
                                        <Input id="id-password" type="password" name="password" required="required" className="form-control" />
                                    </div>
                                    <div className="form-group">
                                        <label className="control-label">Confirm Password *</label>
                                        <Input type="password" name="confirmPassword" required="required" data-parsley-equalto="#id-password" className="form-control" />
                                    </div>
                        ...
                        <form method="post" data-parsley-validate="" noValidate>
                            ...
                            <div className="panel panel-default">
                                ...
                                <div className="panel-body">
                                    ...
                                    <div className="form-group">
                                        <label className="control-label">Password *</label>
                                        <Input type="password" name="password" required="required" className="form-control" />
                                    </div>
                                    <div className="required">* Required fields</div>
                                </div>
                                <div className="panel-footer">
                                ...
                                <div className="panel-body">
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="required" required="required" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                                <code>required</code>
                                            </Col>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="email" name="email" data-parsley-type="email" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="number" data-parsley-type="number" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="integer" data-parsley-type="integer" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="digits" data-parsley-type="digits" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="alphanum" data-parsley-type="alphanum" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="url" data-parsley-type="url" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <div className="col-sm-3">
                                                <Input id="id-source" type="text" placeholder="#id-source" className="form-control" />
                                            </div>
                                            <div className="col-sm-3">
                                                <Input type="text" data-parsley-equalto="#id-source" className="form-control" />
                                            </div>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="minlength" data-parsley-minlength="6" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="maxlength" data-parsley-maxlength="10" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="length" data-parsley-length="[6, 10]" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="min" data-parsley-min="6" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" name="max" data-parsley-max="6" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" data-minwords="6" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" data-maxwords="6" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
                                    ...
                                    <fieldset>
                                        <div className="form-group">
                                            ...
                                            <Col sm={ 6 }>
                                                <Input type="text" data-rangewords="[6,10]" className="form-control" />
                                            </Col>
                                            <Col sm={ 4 }>
